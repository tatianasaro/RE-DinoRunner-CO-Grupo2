...
BACKGROUND = pygame.image.load(os.path.join('Assets\Other\desierto_background.jpg'))
...
class Dinosaur:
    ...
    def __init__(self):
        ...
        self.SonidoGolpe = pygame.mixer.Sound("Assets\Other\sfx-punch.mp3")
...
def main():
    ...
    global game_speed, x_pos_bg, y_pos_bg, points, obstacles, live
    run = True
    ...
    def lives():
        global live, game_speed, Obstacle
        
        if player.dino_rect.colliderect(obstacle.rect):
            obstacles.clear()
            live -= 1
            player.SonidoGolpe.play()
        ...
        text = font.render ("LIVE: " + str(live), True, (0, 0, 0))
        textRect = text.get_rect()
...
def menu(death_count):
    ...
    while run:
        ...
        if death_count == 0:
            text = font.render("press key to start", True, (0, 0, 0))
        elif death_count > 0:
